...
namespace LanguageManager {
    ...
    static std::unordered_map<std::string, std::string> g_defaultJsonFiles = {
        ...
        "TEMP_WAYPOINT": "Set Temporary Waypoint",
        "SHARE_LOCATION": "Share Location In Chat",
        "OPEN_SETTINGS": "Open Settings",
        "SHARE_WP": "Share Waypoint In Chat",
        "RESTORE_WP": "Restore Waypoint",
        ...
        "WP_TAB_ALL": "All",
        "WP_TAB_OVERWORLD": "Overworld",
        "WP_TAB_NETHER": "Nether",
        "WP_TAB_END": "The End",
        "LANG_SELECT": "Language",
        "LOG_VERSION_MISMATCH": "[CRITICAL] Game version mismatch! Current client version",
        "LOG_VERSION_STRICT": "[CRITICAL] ChiyanMap strictly supports version 1.26.40.05 only!",
        ...
        "TEMP_WAYPOINT": "\u8bbe\u7f6e\u4e34\u65f6\u8def\u5f84\u70b9",
        "SHARE_LOCATION": "\u5728\u804a\u5929\u4e2d\u5206\u4eab\u4f4d\u7f6e",
        "OPEN_SETTINGS": "\u6253\u5f00\u8bbe\u7f6e",
        "SHARE_WP": "\u5728\u804a\u5929\u4e2d\u5206\u4eab\u8def\u5f84\u70b9",
        "RESTORE_WP": "\u6062\u590d\u8def\u5f84\u70b9",
        "CONFIRM_DELETE": "\u786e\u8ba4\u5220\u9664",
        ...
        "WP_TAB_ALL": "\u5168\u90e8",
        "WP_TAB_OVERWORLD": "\u4e3b\u4e16\u754c",
        "WP_TAB_NETHER": "\u4e0b\u754c",
        "WP_TAB_END": "\u672b\u5730",
        "LANG_SELECT": "\u8bed\u8a00",
        "LOG_VERSION_MISMATCH": "\u3010\u4e25\u91cd\u8b66\u544a\u3011\u6e38\u620f\u7248\u672c\u4e0d\u9002\u914d\uff01\u5f53\u524d\u5ba2\u6237\u7aef\u7248\u672c\u4e3a",
        "LOG_VERSION_STRICT": "\u3010\u4e25\u91cd\u8b66\u544a\u3011\u8d64\u7130\u5730\u56fe (ChiyanMap) \u5e95\u5c42\u62e6\u622a\u5668\u5f53\u524d\u4e25\u683c\u9650\u5b9a\u4ec5\u517c\u5bb9 1.26.40.05 \u7248\u672c\uff01",
        ...
        "LOG_VERSION_STRICT": "\u3010\u56b4\u91cd\u8b66\u544a\u3011\u8d64\u7130\u5730\u5716 (ChiyanMap) \u5e95\u5c64\u62e6\u622a\u5668\u7576\u524d\u56b4\u683c\u9650\u5b9a\u50c5\u76f8\u5bb9 1.26.40.05 \u7248\u672c\uff01",
        ...
        "TEMP_WAYPOINT": "Tempor\u00e4ren Wegpunkt setzen",
        "SHARE_LOCATION": "Standort im Chat teilen",
        "OPEN_SETTINGS": "Einstellungen \u00f6ffnen",
        "SHARE_WP": "Wegpunkt im Chat teilen",
        "RESTORE_WP": "Wegpunkt wiederherstellen",
        ...
        "LOG_VERSION_STRICT": "[KRITISCH] ChiyanMap unterstützt strikt nur die Version 1.26.40.05!",
        ...
        "TEMP_WAYPOINT": "Point de rep\u00e8re temporaire",
        "SHARE_LOCATION": "Partager la position dans le chat",
        "OPEN_SETTINGS": "Ouvrir les param\u00e8tres",
        "SHARE_WP": "Partager le rep\u00e8re dans le chat",
        "RESTORE_WP": "Restaurer le rep\u00e8re",
        ...
        "LOG_VERSION_STRICT": "[CRITIQUE] ChiyanMap prend strictement en charge uniquement la version 1.26.40.05 !",
        ...
        "TEMP_WAYPOINT": "Titik Jalan Sementara",
        "SHARE_LOCATION": "Bagikan Lokasi di Chat",
        "OPEN_SETTINGS": "Buka Pengaturan",
        "SHARE_WP": "Bagikan Titik Jalan di Chat",
        "RESTORE_WP": "Pulihkan Titik Jalan",
        ...
        "LOG_VERSION_STRICT": "[KRITIS] ChiyanMap secara ketat hanya mendukung versi 1.26.40.05!",
        ...
        "TEMP_WAYPOINT": "Imposta waypoint temporaneo",
        "SHARE_LOCATION": "Condividi posizione in chat",
        "OPEN_SETTINGS": "Apri impostazioni",
        "SHARE_WP": "Condividi waypoint in chat",
        "RESTORE_WP": "Ripristina waypoint",
        ...
        "LOG_VERSION_STRICT": "[CRITICO] ChiyanMap supporta rigorosamente solo la versione 1.26.40.05!",
        ...
        "TEMP_WAYPOINT": "\u4e00\u6642\u30a6\u30a7\u30a4\u30dd\u30a4\u30f3\u30c8\u3092\u8a2d\u5b9a",
        "SHARE_LOCATION": "\u30c1\u30e3\u30c3\u30c8\u3067\u4f4d\u7f6e\u3092\u5171\u6709",
        "OPEN_SETTINGS": "\u8a2d\u5b9a\u3092\u958b\u304f",
        "SHARE_WP": "\u30c1\u30e3\u30c3\u30c8\u3067\u30a6\u30a7\u30a4\u30dd\u30a4\u30f3\u30c8\u3092\u5171\u6709",
        "RESTORE_WP": "\u30a6\u30a7\u30a4\u30dd\u30a4\u30f3\u30c8\u3092\u5fa9\u5143",
        ...
        "LOG_VERSION_STRICT": "\u3010\u91cd\u5927\u306a\u30a8\u30e9\u30fc\u3011ChiyanMap\u306f\u30d0\u30fc\u30b8\u30e7\u30f3 1.26.40.05 \u306e\u307f\u3092\u53b3\u5bc6\u306b\u30b5\u30dd\u30fc\u30c8\u3057\u3066\u3044\u307e\u3059\uff01",
        ...
        "TEMP_WAYPOINT": "\uc784\uc2dc \uc6e8\uc774\ud3ec\uc778\ud2b8 \uc124\uc815",
        "SHARE_LOCATION": "\ucc44\ud305\uc5d0\uc11c \uc704\uce58 \uacf5\uc720",
        "OPEN_SETTINGS": "\uc124\uc815 \uc5f4\uae30",
        "SHARE_WP": "\ucc44\ud305\uc5d0\uc11c \uc6e8\uc774\ud3ec\uc778\ud2b8 \uacf5\uc720",
        "RESTORE_WP": "\uc6e8\uc774\ud3ec\uc778\ud2b8 \ubcf5\uc6d0",
        ...
        "LOG_VERSION_STRICT": "[\uce58\uba85\uc801 \uc624\ub958] ChiyanMap\uc740 1.26.40.05 \ubc84\uc804\ub9cc \uc5c4\uaca9\ud558\uac8c \uc9c0\uc6d0\ud569\ub2c8\ub2e4!",
        ...
        "TEMP_WAYPOINT": "Definir Marcador Tempor\u00e1rio",
        "SHARE_LOCATION": "Compartilhar Localiza\u00e7\u00e3o no Chat",
        "OPEN_SETTINGS": "Abrir Configura\u00e7\u00f5es",
        "SHARE_WP": "Compartilhar Marcador no Chat",
        "RESTORE_WP": "Restaurar Marcador",
        ...
        "LOG_VERSION_STRICT": "[CRÍTICO] ChiyanMap suporta estritamente apenas a versão 1.26.40.05!",
        ...
        "TEMP_WAYPOINT": "\u0423\u0441\u0442\u0430\u043d\u043e\u0432\u0438\u0442\u044c \u0432\u0440\u0435\u043c\u0435\u043d\u043d\u0443\u044e \u0442\u043e\u0447\u043a\u0443",
        "SHARE_LOCATION": "\u041f\u043e\u0434\u0435\u043b\u0438\u0442\u044c\u0441\u044f \u043c\u0435\u0441\u0442\u043e\u043f\u043e\u043b\u043e\u0436\u0435\u043d\u0438\u0435\u043c \u0432 \u0447\u0430\u0442\u0435",
        "OPEN_SETTINGS": "\u041e\u0442\u043a\u0440\u044b\u0442\u044c \u043d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438",
        "SHARE_WP": "\u041f\u043e\u0434\u0435\u043b\u0438\u0442\u044c\u0441\u044f \u0442\u043e\u0447\u043a\u043e\u0439 \u0432 \u0447\u0430\u0442\u0435",
        "RESTORE_WP": "\u0412\u043e\u0441\u0441\u0442\u0430\u043d\u043e\u0432\u0438\u0442\u044c \u0442\u043e\u0447\u043a\u0443",
        ...
        "LOG_VERSION_STRICT": "[\u041a\u0420\u0418\u0422\u0418\u0427\u0415\u0421\u041a\u0410\u042f \u041e\u0428\u0418\u0411\u041a\u0410] ChiyanMap \u0441\u0442\u0440\u043e\u0433\u043e \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u0438\u0432\u0430\u0435\u0442 \u0442\u043e\u043b\u044c\u043a\u043e \u0432\u0435\u0440\u0441\u0438\u044e 1.26.40.05!",
        ...
        "TEMP_WAYPOINT": "\u0e15\u0e31\u0e49\u0e07\u0e08\u0e38\u0e14\u0e40\u0e2a\u0e49\u0e19\u0e17\u0e32\u0e07\u0e0a\u0e31\u0e48\u0e27\u0e04\u0e23\u0e32\u0e27",
        "SHARE_LOCATION": "\u0e41\u0e0a\u0e23\u0e4c\u0e15\u0e33\u0e41\u0e2b\u0e19\u0e48\u0e07\u0e43\u0e19\u0e41\u0e0a\u0e17",
        "OPEN_SETTINGS": "\u0e40\u0e1b\u0e34\u0e14\u0e01\u0e32\u0e23\u0e15\u0e31\u0e49\u0e07\u0e04\u0e48\u0e32",
        "SHARE_WP": "\u0e41\u0e0a\u0e23\u0e4c\u0e08\u0e38\u0e14\u0e40\u0e2a\u0e49\u0e19\u0e17\u0e32\u0e07\u0e43\u0e19\u0e41\u0e0a\u0e17",
        "RESTORE_WP": "\u0e01\u0e39\u0e49\u0e04\u0e37\u0e19\u0e08\u0e38\u0e14\u0e40\u0e2a\u0e49\u0e19\u0e17\u0e32\u0e07",
        ...
        "LOG_VERSION_STRICT": "[\u0e27\u0e34\u0e01\u0e24\u0e15] ChiyanMap \u0e23\u0e2d\u0e07\u0e23\u0e31\u0e1a\u0e40\u0e09\u0e1e\u0e32\u0e30\u0e40\u0e27\u0e2d\u0e23\u0e4c\u0e0a\u0e31\u0e19 1.26.40.05 \u0e40\u0e17\u0e48\u0e32\u0e19\u0e31\u0e49\u0e19!",
        ...
        "TEMP_WAYPOINT": "Ge\u00e7ici \u0130\u015faret Noktas\u0131 Ayarla",
        "SHARE_LOCATION": "Konumu Sohbette Payla\u015f",
        "OPEN_SETTINGS": "Ayarlar\u0131 A\u00e7",
        "SHARE_WP": "\u0130\u015faret Noktas\u0131n\u0131 Sohbette Payla\u015f",
        "RESTORE_WP": "\u0130\u015faret Noktas\u0131n\u0131 Geri Y\u00dckle",
        ...
        "LOG_VERSION_STRICT": "[KR\u0130T\u0130K] ChiyanMap kesinlikle yaln\u0131zca 1.26.40.05 s\u00fcr\u00fcm\u00fcn\u00fc destekler!",
        ...
        "TEMP_WAYPOINT": "\u0412\u0441\u0442\u0430\u043d\u043e\u0432\u0438\u0442\u0438 \u0442\u0438\u043c\u0447\u0430\u0441\u043e\u0432\u0443 \u0442\u043e\u0447\u043a\u0443",
        "SHARE_LOCATION": "\u041f\u043e\u0434\u0456\u043b\u0438\u0442\u0438\u0441\u044f \u043b\u043e\u043a\u0430\u0446\u0456\u0454\u044e \u0432 \u0447\u0430\u0442\u0456",
        "OPEN_SETTINGS": "\u0412\u0456\u0434\u043a\u0440\u0438\u0442\u0438 \u043d\u0430\u043b\u0430\u0448\u0442\u0443\u0432\u0430\u043d\u043d\u044f",
        "SHARE_WP": "\u041f\u043e\u0434\u0456\u043b\u0438\u0442\u0438\u0441\u044f \u0442\u043e\u0447\u043a\u043e\u044e \u0432 \u0447\u0430\u0442\u0456",
        "RESTORE_WP": "\u0412\u0456\u0434\u043d\u043e\u0432\u0438\u0442\u0438 \u0442\u043e\u0447\u043a\u0443",
        ...
        "LOG_VERSION_STRICT": "[\u041a\u0420\u0418\u0422\u0418\u0427\u041d\u0410 \u041f\u041e\u041c\u0418\u041b\u041a\u0410] ChiyanMap \u0441\u0443\u0432\u043e\u0440\u043e \u043f\u0456\u0434\u0442\u0440\u0438\u043c\u0443\u0454 \u043b\u0438\u0448\u0435 \u0432\u0435\u0440\u0441\u0456\u044e 1.26.40.05!",
        ...
        "TEMP_WAYPOINT": "\u0110\u1eb7t \u0111i\u1ec3m \u0111\u01b0\u1eddng t\u1ea1m th\u1eddi",
        "SHARE_LOCATION": "Chia s\u1ebb v\u1ecb tr\u00ed trong chat",
        "OPEN_SETTINGS": "M\u1edf c\u00e0i \u0111\u1eb7t",
        "SHARE_WP": "Chia s\u1ebb \u0111i\u1ec3m \u0111\u01b0\u1eddng trong chat",
        "RESTORE_WP": "Kh\u00f4i ph\u1ee5c \u0111i\u1ec3m \u0111\u01b0\u1eddng",
        ...
        "LOG_VERSION_STRICT": "[NGHI\u00caM TR\u1eccNG] ChiyanMap ch\u1ec9 h\u1ed7 tr\u1ee3 nghi\u00eam ng\u1eb7t phi\u00ean b\u1ea3n 1.26.40.05!",
        ...
        "TEMP_WAYPOINT": "Definir Marcador Tempor\u00e1rio",
        "SHARE_LOCATION": "Partilhar Localiza\u00e7\u00e3o no Chat",
        "OPEN_SETTINGS": "Abrir Defini\u00e7\u00f5es",
        "SHARE_WP": "Partilhar Marcador no Chat",
        "RESTORE_WP": "Restaurar Marcador",
        ...
        "LOG_VERSION_STRICT": "[CRÍTICO] ChiyanMap solo admite la versión 1.26.40.05",
    ...
    const char* GetText(const std::string& key) {
        ...
        if (key == "LOG_VERSION_STRICT") {
            if (g_currentLanguage == "zh_CN") return "【严重警告】赤焰地图 (ChiyanMap) 底层拦截器当前严格限定仅兼容 1.26.40.05 版本！";
            if (g_currentLanguage == "zh_TW") return "【嚴重警告】赤焰地圖 (ChiyanMap) 底層攔截器當前嚴格限定僅相容 1.26.40.05 版本！";
            if (g_currentLanguage == "de") return "[KRITISCH] ChiyanMap unterstützt streng genommen nur Version 1.26.40.05!";
            if (g_currentLanguage == "fr") return "[CRITIQUE] ChiyanMap ne prend en charge que la version 1.26.40.05 !";
            if (g_currentLanguage == "id") return "[KRITIS] ChiyanMap hanya mendukung versi 1.26.40.05!";
            if (g_currentLanguage == "it") return "[CRITICO] ChiyanMap supporta rigorosamente solo la versione 1.26.40.05!";
            if (g_currentLanguage == "ja") return "[重大] ChiyanMap は厳密にバージョン 1.26.40.05 のみをサポートしています！";
            if (g_currentLanguage == "ko") return "[심각] ChiyanMap은 엄격히 버전 1.26.40.05만 지원합니다!";
            if (g_currentLanguage == "pt_BR") return "[CRÍTICO] O ChiyanMap é compatível estritamente apenas com a versão 1.26.40.05!";
            if (g_currentLanguage == "ru") return "[КРИТИЧНО] ChiyanMap строго поддерживает только версию 1.26.40.05!";
            if (g_currentLanguage == "th") return "[วิกฤต] ChiyanMap รองรับเฉพาะเวอร์ชัน 1.26.40.05 เท่านั้น!";
            if (g_currentLanguage == "tr") return "[KRİTİK] ChiyanMap yalnızca sürüm 1.26.40.05'ü destekler!";
            if (g_currentLanguage == "uk") return "[КРИТИЧНО] ChiyanMap суворо підтримує лише версію 1.26.40.05!";
            if (g_currentLanguage == "vi") return "[QUAN TRỌNG] ChiyanMap chỉ hỗ trợ phiên bản 1.26.40.05!";
            if (g_currentLanguage == "es") return "[CRÍTICO] ¡ChiyanMap solo es compatible estrictamente con la versión 1.26.40.05!";
            return "[CRITICAL] ChiyanMap strictly supports version 1.26.40.05 only!";
        }
