...
namespace LanguageManager {
    ...
    const char* GetText(const std::string& key) {
        if (key.length() >= 6 && key.substr(0, 6) == "BIOME_") {
            ...
            {"zh_CN", {{ {"BIOME_PLAINS","平原"}, {"BIOME_DESERT","沙漠"}, {"BIOME_EXTREME_HILLS","风袭丘陵"}, {"BIOME_FOREST","森林"}, {"BIOME_TAIGA","针叶林"}, {"BIOME_MANGROVE_SWAMP","红树林沼泽"}, {"BIOME_SWAMP","沼泽"}, {"BIOME_RIVER","河流"}, {"BIOME_HELL","下界荒野"}, {"BIOME_THE_END","末地"}, {"BIOME_FROZEN_OCEAN","冻洋"}, {"BIOME_WARM_OCEAN","暖洋"}, {"BIOME_COLD_OCEAN","冷洋"}, {"BIOME_OCEAN","海洋"}, {"BIOME_SNOWY_PLAINS","积雪平原"}, {"BIOME_ICE_SPIKES","冰刺平原"}, {"BIOME_MUSHROOM","蘑菇岛"}, {"BIOME_BEACH","海滩"}, {"BIOME_BAMBOO_JUNGLE","竹林"}, {"BIOME_JUNGLE","丛林"}, {"BIOME_BIRCH_FOREST","桦木森林"}, {"BIOME_DARK_FOREST","黑森林"}, {"BIOME_SAVANNA","热带草原"}, {"BIOME_MESA","恶地"}, {"BIOME_CHERRY","樱花树林"}, {"BIOME_CRIMSON_FOREST","绯红森林"}, {"BIOME_WARPED_FOREST","诡异森林"}, {"BIOME_SOUL_SAND_VALLEY","灵魂沙峡谷"}, {"BIOME_BASALT_DELTAS","玄武岩三角洲"}, {"BIOME_MEADOW","草甸"}, {"BIOME_GROVE","雪林"}, {"BIOME_SNOWY_SLOPES","积雪的山坡"}, {"BIOME_JAGGED_PEAKS","尖峭山峰"}, {"BIOME_FROZEN_PEAKS","冰封山峰"}, {"BIOME_STONY_PEAKS","裸岩山峰"}, {"BIOME_DEEP_DARK","深暗之域"}, {"BIOME_PALE_GARDEN","苍白之园"}, {"BIOME_UNKNOWN","未知群系"}, {"BIOME_LUKEWARM_OCEAN","温水海洋"}, {"BIOME_DEEP_OCEAN","深海"}, {"BIOME_DEEP_FROZEN_OCEAN","冰冻深海"}, {"BIOME_DEEP_COLD_OCEAN","冷水深海"}, {"BIOME_DEEP_LUKEWARM_OCEAN","温水深海"}, {"BIOME_DEEP_WARM_OCEAN","暖水深海"}, {"BIOME_FROZEN_RIVER","冻河"}, {"BIOME_STONY_SHORE","石岸"}, {"BIOME_SNOWY_BEACH","积雪沙滩"}, {"BIOME_WINDSWEPT_FOREST","风袭森林"}, {"BIOME_WINDSWEPT_GRAVELLY_HILLS","风袭沙砾丘陵"}, {"BIOME_WINDSWEPT_SAVANNA","风袭热带草原"}, {"BIOME_SAVANNA_PLATEAU","热带高原"}, {"BIOME_SPARSE_JUNGLE","稀疏丛林"}, {"BIOME_SNOWY_TAIGA","积雪针叶林"}, {"BIOME_OLD_GROWTH_PINE_TAIGA","原始松木针叶林"}, {"BIOME_OLD_GROWTH_SPRUCE_TAIGA","原始云杉针叶林"}, {"BIOME_OLD_GROWTH_BIRCH_FOREST","原始桦木森林"}, {"BIOME_FLOWER_FOREST","繁花森林"}, {"BIOME_SUNFLOWER_PLAINS","向日葵平原"}, {"BIOME_ERODED_BADLANDS","风蚀恶地"}, {"BIOME_WOODED_BADLANDS","疏林恶地"} , {"BIOME_LUSH_CAVES","繁茂洞穴"}, {"BIOME_DRIPSTONE_CAVES","滴水石洞穴"}}}},
            {"zh_TW", {{ {"BIOME_PLAINS","平原"}, {"BIOME_DESERT","沙漠"}, {"BIOME_EXTREME_HILLS","風襲丘陵"}, {"BIOME_FOREST","森林"}, {"BIOME_TAIGA","針葉林"}, {"BIOME_MANGROVE_SWAMP","紅樹林沼澤"}, {"BIOME_SWAMP","沼澤"}, {"BIOME_RIVER","河流"}, {"BIOME_HELL","下界荒野"}, {"BIOME_THE_END","末地"}, {"BIOME_FROZEN_OCEAN","凍洋"}, {"BIOME_WARM_OCEAN","暖洋"}, {"BIOME_COLD_OCEAN","冷洋"}, {"BIOME_OCEAN","海洋"}, {"BIOME_SNOWY_PLAINS","積雪平原"}, {"BIOME_ICE_SPIKES","冰刺平原"}, {"BIOME_MUSHROOM","蘑菇島"}, {"BIOME_BEACH","海灘"}, {"BIOME_BAMBOO_JUNGLE","竹林"}, {"BIOME_JUNGLE","叢林"}, {"BIOME_BIRCH_FOREST","樺木森林"}, {"BIOME_DARK_FOREST","黑森林"}, {"BIOME_SAVANNA","熱帶草原"}, {"BIOME_MESA","惡地"}, {"BIOME_CHERRY","櫻花樹林"}, {"BIOME_CRIMSON_FOREST","緋紅森林"}, {"BIOME_WARPED_FOREST","詭異森林"}, {"BIOME_SOUL_SAND_VALLEY","靈魂沙峽谷"}, {"BIOME_BASALT_DELTAS","玄武岩三角洲"}, {"BIOME_MEADOW","草甸"}, {"BIOME_GROVE","雪林"}, {"BIOME_SNOWY_SLOPES","積雪的山坡"}, {"BIOME_JAGGED_PEAKS","尖峭山峰"}, {"BIOME_FROZEN_PEAKS","冰封山峰"}, {"BIOME_STONY_PEAKS","裸岩山峰"}, {"BIOME_DEEP_DARK","深暗之域"}, {"BIOME_PALE_GARDEN","蒼白之園"}, {"BIOME_UNKNOWN","未知群系"}, {"BIOME_LUKEWARM_OCEAN","溫水海洋"}, {"BIOME_DEEP_OCEAN","深海"}, {"BIOME_DEEP_FROZEN_OCEAN","冰凍深海"}, {"BIOME_DEEP_COLD_OCEAN","冷水深海"}, {"BIOME_DEEP_LUKEWARM_OCEAN","溫水深海"}, {"BIOME_DEEP_WARM_OCEAN","暖水深海"}, {"BIOME_FROZEN_RIVER","凍河"}, {"BIOME_STONY_SHORE","石岸"}, {"BIOME_SNOWY_BEACH","積雪沙灘"}, {"BIOME_WINDSWEPT_FOREST","風襲森林"}, {"BIOME_WINDSWEPT_GRAVELLY_HILLS","風襲沙礫丘陵"}, {"BIOME_WINDSWEPT_SAVANNA","風襲熱帶草原"}, {"BIOME_SAVANNA_PLATEAU","熱帶高原"}, {"BIOME_SPARSE_JUNGLE","稀疏叢林"}, {"BIOME_SNOWY_TAIGA","積雪針葉林"}, {"BIOME_OLD_GROWTH_PINE_TAIGA","原始松木針葉林"}, {"BIOME_OLD_GROWTH_SPRUCE_TAIGA","原始雲杉針葉林"}, {"BIOME_OLD_GROWTH_BIRCH_FOREST","原始樺木森林"}, {"BIOME_FLOWER_FOREST","繁花森林"}, {"BIOME_SUNFLOWER_PLAINS","向日葵平原"}, {"BIOME_ERODED_BADLANDS","風蝕惡地"}, {"BIOME_WOODED_BADLANDS","疏林惡地"}, {"BIOME_LUSH_CAVES","繁茂洞穴"}, {"BIOME_DRIPSTONE_CAVES","滴水石洞穴"} }}},
